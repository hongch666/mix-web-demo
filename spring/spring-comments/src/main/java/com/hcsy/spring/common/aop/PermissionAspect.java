...
public class PermissionAspect {
    ...
    public Object checkPermission(ProceedingJoinPoint joinPoint, RequirePermission requirePermission) throws Throwable {
        ...
        // 获取当前用户信息
        Result userResult = userClient.getById(currentUserId);
        User currentUser = BeanUtil.toBean((Map<?, ?>) userResult.getData(), User.class);
        if (currentUser == null) {
            ...
            for (int i = 0; i < paramNames.length; i++) {
                ...
                if (paramName.equals(paramNames[i])) {
                    ...
                    if (paramName.equals("userDto")) {
                        ...
                        Result userResult = userClient.findByUsername(username);
