class Defaults:
    ...
    # 候选上限需不小于 GoZero 侧 SEARCH_GRAPH_CANDIDATE_LIMIT，否则召回放大的候选会被截断
    GRAPH_SEARCH_CANDIDATE_LIMIT: int = 200

    # ===== 向量搜索配置 =====
    VECTOR_SEARCH_ENABLED: bool = True
    # 候选上限需不小于 GoZero 侧 SEARCH_VECTOR_CANDIDATE_LIMIT，否则召回放大的候选会被截断
    VECTOR_SEARCH_CANDIDATE_LIMIT: int = 200
