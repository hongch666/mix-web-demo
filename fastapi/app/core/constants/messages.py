...
class Messages:
    ...
    GLM_AGENT_INITIALIZATION_SUCCESS: str = "GLM Agent服务初始化完成"

    GLM_CALL_FAILED_ERROR: str = "GLM调用失败"
    ...
    ERROR_GLM_CALL_FAILED: str = "GLM_CALL_FAILED"

    ERROR_GLM_NOT_CONFIGURED: str = "GLM_NOT_CONFIGURED"
