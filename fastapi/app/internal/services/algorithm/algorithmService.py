...
class AlgorithmService:
    ...
    # 脚本参数名映射表: (weight_key, script_param_name, description), 当 Painless 脚本中的 params.xxx 参数名变化时，只需修改此映射表
    SCRIPT_PARAM_MAPPINGS: List[tuple] = [
        # ES 传统8项权重
    ...
    def get_script_params(self) -> Dict[str, Any]:
        ...
        for weight_key, param_name, desc in self.SCRIPT_PARAM_MAPPINGS:
            params.append(
                ScriptParamItem(
