...
class ArticleMapper:
    ...
    async def get_top10_articles_hive_mapper(self):
        columns = [
    ...
    async def get_top10_articles_spark_mapper(self):
    ...
    async def get_top10_articles_db_mapper(self):
        articles = await self.get_all_articles_mapper()
        # 按views降序取前10
