...
func NewInternalServerError(message string, err string) *BusinessError {
	return NewBusinessError(constants.HttpInternalServerError, message, err)
}
...
func NewServiceUnavailableError(message string, err string) *BusinessError {
	return NewBusinessError(constants.HttpServiceUnavailable, message, err)
}
...
func NewServiceUnavailableErrorSame(message string) *BusinessError {
	return NewBusinessErrorSame(constants.HttpServiceUnavailable, message)
}
