...
(
    ...
    tags String, status Int8, views Int32, create_at DateTime, update_at DateTime
)
...
(
    id Int64, name String, create_time DateTime, update_time DateTime
)
...
(
    id Int64, name String, category_id Int64, create_time DateTime, update_time DateTime
)
ENGINE = ReplacingMergeTree(update_time)
ORDER BY id;
...
(
    event_id String, user_id Int64, article_id Int64, action String,
...
(
    sub_category_id Int64, sub_category_name String, parent_category_id Int64,
    parent_category_name String, update_time DateTime
)
ENGINE = ReplacingMergeTree(update_time)
...
(
    ...
    sub_category_id Int64, parent_category_id Int64, parent_category_name String,
    create_date Date, create_at DateTime, update_at DateTime
)
ENGINE = ReplacingMergeTree(update_at)
ORDER BY id;
...
(
    event_id String, source_type String, source_id Int64, action_type String,
    user_id Int64, article_id Int64, action_date Date, action_time DateTime
)
...
(
    stat_date Date, article_id Int64, user_id Int64, parent_category_id Int64,
    views Int64, like_count Int64, collect_count Int64, comment_count Int64
)
ENGINE = MergeTree
...
(
    stat_date Date, user_id Int64, like_count Int64, collect_count Int64,
    comment_count Int64, focus_count Int64, liked_articles UInt64,
...
(
    ...
    create_at DateTime, update_at DateTime, user_id Int64, sub_category_id Int64,
    stat_time DateTime
)
...
(
    parent_category_id Int64, category_name String, article_count Int64,
    stat_time DateTime
)
ENGINE = ReplacingMergeTree(stat_time)
...
(
    id UInt8, stat_time DateTime, total_views Int64, total_articles Int64,
    active_authors UInt64, average_views Float64, total_likes Int64,
    average_likes Float64, total_collects Int64, average_collects Float64
)
ENGINE = ReplacingMergeTree(stat_time)
ORDER BY id;
...
(
    user_id Int64, user_name String, total_likes_given Int64,
    total_collects_given Int64, total_comments Int64, total_focus Int64,
    total_articles Int64, total_views Int64, last_active_time DateTime,
    stat_time DateTime
)
ENGINE = ReplacingMergeTree(stat_time)
ORDER BY user_id;
